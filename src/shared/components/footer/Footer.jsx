            ...
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div className="mt-16">
                    ...
                    <div className="mt-16 sm:flex sm:items-center sm:justify-between">
                        <div
                            className="flex justify-center text-yellow-600 text-4xl font-bold space-x-5 dark:text-teal-300 sm:justify-start"
                        >
                            {/* <svg
                                className="h-8"
                                viewBox="0 0 118 24"
                            ...
                            <img src="/favicon.png" alt="" /><h3> Kiddos.</h3>
                        </div>

                        <p
                            className="mt-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:mt-0 sm:text-right"
                        >
